      ...
      {categories.map((cat) => (
        <section key={cat} className="mb-16">
          ...
          <div className="flex justify-between items-center mb-6 border-b border-slate-100 pb-4">
            ...
            <Link href={`/category/${cat}`} className="text-[10px] font-black text-gray-400 hover:text-black transition flex items-center gap-1 uppercase tracking-widest">
                ...
                <div key={p._id} className="group border border-slate-100 rounded-2xl p-2 transition hover:border-orange-500 bg-white">
                  ...
                  <div className="mt-3 px-1">
                    ...
                    <div className="flex justify-between items-center mt-3">
                      <p className="text-lg font-black text-gray-900 tracking-tighter">${p.price}</p>
                      <Link href={`/product/${p._id}`} className="text-[9px] font-bold text-orange-600 uppercase border border-orange-100 px-2 py-1 rounded-md hover:bg-orange-50 transition">
                        Details
                      </Link>
                    </div>
                  </div>
